...
class RedBlackTree():
    ...
    def successor(self, x) -> Node or None:
    ...
    def predecessor(self, x) -> Node or None:
...
if __name__ == "__main__":
    ...
    bst.insert(25)
    bst.pretty_print()
    print(bst.searchTree(25))
    print(bst.predecessor(bst.searchTree(25)))
    print(bst.successor(bst.searchTree(25)))
    bst.insert(40)
    bst.insert(80)
    bst.delete_node(25)
    bst.pretty_print()
